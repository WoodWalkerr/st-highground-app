...
const Navbar = () => {
    ...
    useEffect(() => {
        const storedLoggedIn =
            Boolean(jwt) && Object.keys(userData).length !== 0
                    ...
                    <ul className="hidden md:flex">
                        {loggedIn &&
                            links.map(({ id, link }) => (
                                <li
                                    key={id}
                                    className="px-9 font-medium cursor-pointer hover:text-green-700"
                                >
                                    <Link
                                        activeClass="active"
                                        to={link}
                    ...
                    {loggedIn ? (
                        ...
                        <ul className="list-none flex justify-between items-center">
                            <li className="px-3 cursor-pointer font-medium tracking-wider hover:scale-100 hover:text-gray-700">
                                <button
                                    className="uppercase text-sm flex justify-center items-center hover:text-green-500"
                                    onClick={handleLogin}
                                >
