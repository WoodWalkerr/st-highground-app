...
import { AiOutlineUser, AiOutlineUnorderedList } from '../icons/icons'
            ...
            <div className="flex-1">
                <div className="p-4 md:ml-64">
                        ...
                        <div className="flex items-center flex-col justify-center h-screen mb-4  pr-[55px]">
                            <table className="max-w-6xl shadow-md overflow-hidden rounded-[20px] bg-[#093545]">
                                <thead>
                                    <tr >
                                        <th
                                            colSpan={11}
                                            className="text-start pl-10 pb-4 pt-7 text-sm font-light text-gray-300 flex justify-between"
                                        >List Dashboard
                                ...
                                <tbody>
                                    {currentData.map((user, index) => (
                                        ...
                                        >
                                            <td className="px-6 bg-[#093545] text-center text-white font-light">
                                                {startIndex + index}
                                            </td>
                                            <td className="px-6 bg-[#093545] text-center text-white font-light">
                                                {user.name}
                            ...
                            <div class="flex justify-center mt-4">
                                <nav class="bg-[#eaf0f7] rounded-lg shadow-md p-3">
                                    <ReactPaginate
                                        ...
                                        pageClassName={
                                            'flex items-center justify-center w-8 h-8 mx-1 text-sm font-medium text-gray-700 bg-white border rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform transition duration-200 ease-in-out'
                                        }
                                        activeClassName={
                                            'text-blue-700 bg-blue-500 rounded-md'
                                        }
                                        previousClassName={
                                            'px-4 py-2 text-sm font-medium text-gray-700 bg-white border rounded-l-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform transition duration-200 ease-in-out'
                                        }
                                        nextClassName={
                                            'px-4 py-2 text-sm font-medium text-gray-700 bg-white border rounded-r-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform transition duration-200 ease-in-out'
                                        }
